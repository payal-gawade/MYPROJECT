<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="webdev_admin.aspx.cs" Inherits="project_TDT.webdev_admin" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TdtProjectConnectionString9 %>" SelectCommand="SELECT * FROM [admission] WHERE (([domain] = @domain) AND ([domain] = @domain2))">
            <SelectParameters>
                <asp:Parameter DefaultValue="Sql" Name="domain" Type="String" />
                <asp:Parameter DefaultValue="Web Development" Name="domain2" Type="String" />
            </SelectParameters>
           </asp:SqlDataSource>
   </center> 
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource2" Visible="False">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TdtProjectConnectionString10 %>" SelectCommand="SELECT * FROM [webd]">
            </asp:SqlDataSource>
            <br />
    </center> </form>
</body>
