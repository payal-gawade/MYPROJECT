<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sql.aspx.cs" Inherits="project_TDT.sql" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>SQL</title> <style>
        .resume .resume-title {
  font-size: 26px;
  font-weight: 700;
  margin-top: 20px;
    ...
    <form id="form1" runat="server">
      ...
      <div class="container">
          ...
          <h3 class="resume-title">Syallabus</h3>
                ...
                <h4>SQL</h4>
                <p>Introduction</p> <p>What is SQL</p><p>Why is SQL is Required</p><p>Syntax</p><p>Important Command</p><p>Installation</p><p>DAta Types</p><p>Operators</p><p>Data Bases</p><p>Table</p><p>Select</p><p>Clauses</p><p>Order by Clause</p><p>Joins</p><p>Keys</p>
               <button class="btn btn-primary"><a href="pdf/SQL ppt.pdf" target="download">Syallabus PDF</a></button>
              </div>

             <div class="resume-item">
                <h4>PL/SQL</h4>
                <p>Introduction</p> <p>What is Pl/SQL</p><p>Data types</p><p>Operators</p><p>Procedure </p><p>Triggers</p>
               <button class="btn btn-primary"><a href="pdf/SQL ppt.pdf" target="download">Syallabus PDF</a></button>
              </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">SQL</a></h4>
