<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="java_admin.aspx.cs" Inherits="project_TDT.java_admin" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TdtProjectConnectionString9 %>" SelectCommand="SELECT * FROM [java]"></asp:SqlDataSource>
   </center> 
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="#DEBA84" BorderColor="#DEBA84" BorderStyle="None" BorderWidth="1px" CellPadding="3" CellSpacing="2" DataSourceID="SqlDataSource2" Visible="False">
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:TdtProjectConnectionString10 %>" SelectCommand="SELECT * FROM [admission] WHERE ([domain] = @domain)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="Java Deveolper" Name="domain" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
            <br />
    </center> </form>
