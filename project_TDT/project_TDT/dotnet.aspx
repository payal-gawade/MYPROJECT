<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dotnet.aspx.cs" Inherits="project_TDT.dotnet" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Dot Net</title> <style>
        .resume .resume-title {
  font-size: 26px;
  font-weight: 700;
  margin-top: 20px;
    ...
    <form id="form1" runat="server"> 
      ...
      <div class="container">
          ...
          <h3 class="resume-title">Syallabus</h3>
                ...
                <h4>C#(Used In Backend)</h4>
                <p>Introduction</p> <p>History</p><p>Features</p><p>Data Types</p><p>Variables</p><p>Control Statements</p><p>Functions</p><p>Array</p><p>OOPS</p><p>Strings</p><p>Access Modifier</p><p>File IO System</p><p>Collection</p><p>Lambda Expression</p><p>Multi-Threading</p>
               <button class="btn btn-primary"><a href="pdf/C#/C#-Language-PPT (1) (1).pdf" target="download">Syallabus PDF</a></button>
              </div>

             <div class="resume-item">
                <h4>ASP.Net</h4>
                <p>Introduction</p> <p>ASP Tools</p> <p>ADO .Net</p> <p>Validations</p> <p>MVC</p> <p>Entity Framework</p> <p>Navigation</p> <p>DesignWeb Pages</p> 
                <button class="btn btn-primary"><a href="pdf/C#/C#-Language-PPT (1) (1).pdf" target="download">Syallabus PDF</a></button>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-md-8 col-lg-4 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box">
              ...
              <h4 class="title"><a href="">DOT Net language</a></h4>
