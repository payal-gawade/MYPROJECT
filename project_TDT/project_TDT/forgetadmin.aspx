<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forgetadmin.aspx.cs" Inherits="project_TDT.forgetadmin" %>
        ...
        <table class="auto-style1">
            ...
            <tr>
                <td class="auto-style6">
                    <asp:Label ID="Label3" runat="server" Text="AdminId:"></asp:Label>
                </td>
                <td class="auto-style3">
            ...
            <tr>
                <td class="auto-style6">&nbsp;</td>
                <td class="auto-style3">
                    <asp:Button ID="Button1" runat="server" Height="41px" Text="Change Password" Width="212px" BackColor="Black" ForeColor="White" OnClick="Button1_Click" />
                </td>
                <td>&nbsp;</td>
            </tr>
            <tr>
