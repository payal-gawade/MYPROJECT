<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="registermanager.aspx.cs" Inherits="project_TDT.registermanager" %>
    ...
    <form id="form1" runat="server">
        ...
        <table class="auto-style1">
            ...
            <tr>
                ...
                <td class="auto-style25"><h5>Manager Registeration Form</h5>&nbsp;</td>
            ...
            <tr>
                ...
                <td class="auto-style3">
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="auto-style5" Height="35px" Width="199px" placeholder="First Name" required name="First Name"></asp:TextBox>
            ...
            <tr>
                <td class="auto-style11">
                    <asp:Label ID="Label2" runat="server" Text="Manager Id:"></asp:Label>
                </td>
