...
<body class="jk">
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style2">&nbsp;</td>
            <td class="auto-style3">
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TdtProjectConnectionString4 %>" SelectCommand="SELECT * FROM [java]"></asp:SqlDataSource>
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="auto-style2">&nbsp;</td>
            <td class="auto-style3">
                <asp:Button ID="Button1" runat="server" BackColor="#009933" ForeColor="White" Height="37px" Text="Admission" Width="182px" OnClick="Button1_Click2" />
            </td>
            <td>&nbsp;</td>
        </tr>
        <tr>
