<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sql_admin.aspx.cs" Inherits="project_TDT.sql_admin" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TdtProjectConnectionString9 %>" SelectCommand="SELECT * FROM [sql]"></asp:SqlDataSource>
   </center> 
